...
export const duelRanks = [
  { id: "iron", name: "黑铁", min: 0, max: 14, color: "#5b6470" },
  { id: "bronze", name: "青铜", min: 15, max: 29, color: "#a66a3d" },
  { id: "silver", name: "白银", min: 30, max: 44, color: "#aeb7c2" },
  { id: "gold", name: "黄金", min: 45, max: 59, color: "#d4a02f" },
  { id: "platinum", name: "铂金", min: 60, max: 74, color: "#5fb8b0" },
  { id: "diamond", name: "钻石", min: 75, max: 89, color: "#5a9fe8" },
  { id: "master", name: "超凡大师", min: 90, max: 104, color: "#9b6ce8" },
  { id: "challenger", name: "最强王者", min: 105, max: 120, color: "#dc5b37" }
];
