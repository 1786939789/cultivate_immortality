...
export async function readLiveRankingIncremental(saveId, kind = "power", options = {}) {
  ...
  const [[totalRow]] = await mysqlPool.query("SELECT COUNT(*) AS total FROM cultivator_metrics_v2 WHERE save_id=?", [saveId]);
