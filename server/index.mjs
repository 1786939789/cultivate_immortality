...
const liteActionRoutes = new Set([
  ...
  "/api/admin/task-definitions/update",
  "/api/admin/task-definitions/delete",
  "/api/admin/task-definitions/toggle",
  "/api/player/portrait",
  "/api/admin/settings",
  "/api/skills/upgrade",
  "/api/rest",
...
async function handleApi(req, res, url) {
  ...
  const routes = {
    ...
    "/api/admin/task-definitions": (state) => createTaskDefinition(state, body),
    "/api/admin/task-definitions/update": (state) => updateTaskDefinition(state, body),
    "/api/admin/task-definitions/delete": (state) => deleteTaskDefinition(state, body),
    "/api/admin/task-definitions/toggle": (state) => toggleTaskDefinition(state, body),
